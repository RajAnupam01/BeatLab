  ...
  return (
    <div className="flex justify-center items-center h-screen max-h-screen" >
      <div className="bg-black text-white p-8 rounded-lg shadow-lg  w-full max-w-md" >
        <h2 className="text-3xl font-semibold text-center mb-8">Login to BeatLab</h2>
        ...
        <div className="text-center mt-6">
          <Link to="/register" className="text-sm text-gray-400 hover:text-gray-300">don't have account ? Register</Link>
        </div>
      </div>
    </div>
  )
